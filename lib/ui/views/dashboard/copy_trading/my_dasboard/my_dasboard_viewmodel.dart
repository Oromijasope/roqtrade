...
class MyDasboardViewModel extends BaseViewModel {
  ...
  String selectedTraderCoin = 'bitcoin';
  ...
  Future showImportantBottomSheet() async {
    await _bottomSheetService.showCustomSheet(
      ...
      description:
          'Please understand the risks involved before proceeding with copy trading.',
