...
// in roqtrade/test/helpers/test_helpers.dart.
...
import 'package:roqtrade/services/api_service.dart' as _i7;
import 'package:roqtrade/services/utils_service.dart' as _i9;
...
class MockApiService extends _i1.Mock implements _i7.ApiService {
  @override
  _i5.Future<Map<String, dynamic>> fetchCoinData(String? symbol) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCoinData,
          [symbol],
  ...
  @override
  _i5.Future<List<Map<String, dynamic>>> fetchTop20Coins() =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchTop20Coins,
          [],
  ...
  @override
  _i5.Future<List<_i8.FlSpot>> fetchCoinMarketChart(
    String? coinId,
    int? days,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i5.Future<List<_i8.FlSpot>>.value(<_i8.FlSpot>[]),
        returnValueForMissingStub:
            _i5.Future<List<_i8.FlSpot>>.value(<_i8.FlSpot>[]),
      ) as _i5.Future<List<_i8.FlSpot>>);
}

/// A class which mocks [UtilsService].
///
/// See the documentation for Mockito's code generation for more information.
class MockUtilsService extends _i1.Mock implements _i9.UtilsService {
  @override
  ...
  @override
  void infoMsgNotification({required String? text}) => super.noSuchMethod(
        Invocation.method(
          #infoMsgNotification,
          [],
          {#text: text},
  ...
  @override
  void invalidNetworkNotification() => super.noSuchMethod(
        Invocation.method(
          #invalidNetworkNotification,
          [],
        ),
        returnValueForMissingStub: null,
      );
  ...
  @override
  void validNetworkNotification() => super.noSuchMethod(
        Invocation.method(
          #validNetworkNotification,
          [],
        ),
        returnValueForMissingStub: null,
      );
